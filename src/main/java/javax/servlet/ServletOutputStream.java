...
public class ServletOutputStream extends OutputStream {
	...
	/**
	 * Writes a <code>String</code> to the client, without a carriage return-line
	...
	/**
	 *
	 * Writes a <code>long</code> value to the client, with no carriage return-line
	 * feed (CRLF) at the end.
	 *
	 * @param l
	...
	/**
	 *
	 * Writes a <code>float</code> value to the client, with no carriage return-line
	 * feed (CRLF) at the end.
	 *
	 * @param f
